...
$params->arrayInput = array("recherche","id_mag");
$INTERFACE = new OTRInterface($params);

//--------------------------------------------------------------------------
// phpsql/getArticleAutoCompl.php?milis=123450&recherche=otte&id_mag=1
...
$params->sql = "SELECT a.`id`,a.`id_mag`, a.`libelle`, a.`prix`, a.`tr`
    ...
    WHERE 1=1
    AND a.`libelle` like '%".$INTERFACE->inputs["recherche"]."%'
    AND a.`id_mag` = :id_mag
